...
public class Addcategoryadminproduct extends AppCompatActivity {
    ...
    private Button CheckOrdersBtn,buttonlogout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckOrdersBtn=findViewById(R.id.CheckNewOrders);
        ...
        buttonlogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Addcategoryadminproduct.this,MainActivity.class);
        ...
        CheckOrdersBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Addcategoryadminproduct.this,Admin_new_Orders.class);
                //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                //finish();
            }
