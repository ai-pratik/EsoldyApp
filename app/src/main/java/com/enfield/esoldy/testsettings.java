...
public class testsettings extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        startActivity(new Intent(testsettings.this, NavgiationhomeActivity.class));
        Toast.makeText(testsettings.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(testsettings.this, testsettings.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(testsettings.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
